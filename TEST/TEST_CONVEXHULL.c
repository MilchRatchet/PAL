...
void TEST_CONVEXHULL_JARVIS() {
  TEST_PRINT_INPROGRESS("CGL_CONVEXHULL_JARVIS");
  ...
  TEST_PRINT_RESULT(success, "CGL_CONVEXHULL_JARVIS");
...
void TEST_CONVEXHULL_CHAN() {
  TEST_PRINT_INPROGRESS("CGL_CONVEXHULL_CHAN");
  ...
  CGL_Convexhull_t result = CGL_CONVEXHULL_CHAN(points, count);
  ...
  TEST_PRINT_RESULT(success, "CGL_CONVEXHULL_CHAN");
